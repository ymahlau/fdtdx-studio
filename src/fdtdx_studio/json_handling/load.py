...
class Import:
    ...
    def import_Detector(self, obj):
        ...
        match type:
            ...
            case "FieldDetector":
                arguments.update({"reduce_volume": obj["reduce_volume"], "components": obj["components"]["__value__"]})
    ...
    def import_objects(self, project_data: list[dict[str, Any]]):
        ...
        for item in project_data:
            ...
            match type:
                ...
                case "ModePlaneSource" | "GaussianPlaneSource":
                    self.import_Source(item)
    ...
    async def import_material_list(self, obj):
        for i in range(0, len(obj)):
            self.controller.model.material.create_new_material(
                obj[i]["permeability"],
                obj[i]["permittivity"],
