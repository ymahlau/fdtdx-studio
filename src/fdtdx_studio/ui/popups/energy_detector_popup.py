...
class EnergyDetectorPopup(BaseDetectorPopup):
    ...
    def build_detector_specific_ui(self):
        ...
        ui.label("Slice positions (optional)").style("font-size: 13px; font-weight: 600; margin-bottom: 6px")

        ui.label(
            "Set a slice position (in relative/object coordinates as expected by fdtdx). Leave empty for None."
