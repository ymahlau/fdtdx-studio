...
class ModeOverlapDetectorPopup(BaseDetectorPopup):
    ...
    def build_detector_specific_ui(self):
        ui.label("Mode Overlap Parameters").style("font-size: 14px; font-weight: bold; margin-bottom: 6px")
        ...
        self.input_mode_index = ui.number(label="Mode Index", value=0, min=0, precision=0).classes("w-full")
